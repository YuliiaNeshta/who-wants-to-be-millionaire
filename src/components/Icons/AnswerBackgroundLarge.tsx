...
interface AnswerBackgroundLargeProps {
  onClick?: () => void;
  className?: string;
}

export const AnswerBackgroundLarge: FC<AnswerBackgroundLargeProps> = ({ onClick, className }) => {
  return (
    <svg
      onClick={onClick}
      className={className}
    ...
    >
      <path d="M388 36L405 36" stroke="currentColor" />
